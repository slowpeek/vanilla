...
#+begin_example
  vanilla upgrade [--lang <lang>] [--base <dir>] <package>
#+end_example
...
- upgrade :: Try to upgrade (or install) a package and refresh its
  symlink in the base dir in the case.

  Example: =vanilla upgrade firefox=
...
- install :: Install a previously downloaded archive into the base
  dir.

  Example: =vanilla install firefox-91.0.tar.bz2=
